...
###FIX
plot(x=Tjunc$Mean.Area.Covered, y=Tjunc$Mean.Abundance.SD,pch=19,ylim=c(30,140),ylab="SD of Abundance Estimate", xlab=expression("Mean Area Covered (m^2)"))
text(y=Tjunc$Mean.Abundance.SD, x=Tjunc$Mean.Area.Covered, Tjunc$spacing, pos=3)
...
#DENSITY OF T-JUNC = 0.0394
16996891*0.0394
#DENSITY OF PICNIC = 0.153
16996891*0.153

#his calculation
16996891*.0061

krent2<-data.frame("From"=c("Krening", "Picnic", "T-Junction"), "Estimated Density"=c(0.0061,0.153,0.0394), "Estimated Abundance"
                   = c(103086,2600524,669677.5))
